...
Open Shaders' own logo ([.github/assets/logo](.github/assets/logo)), used in the FOMOD installer header, is under the same kind of restriction as upstream's — non-GPL, unmodified-use only — see the LICENSE file in that directory.
