...
namespace
{
	...
	// GET_INSTANCE_MEMBER doesn't apply: this class's VR accessor returns a
	// pointer, unlike most classes' reference-returning GetVRRuntimeData().
	// underwaterBaseData also has no CommonLib GetXxx() accessor, unlike
