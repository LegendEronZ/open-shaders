...
public:
	...
	struct Settings
	{
		...
		uint UseStaticIBL = 1;
		float ExteriorDALCAmount = 0.0f;
		float InteriorDALCAmount = 0.0f;
		float ExteriorEnvIBLScale = 0.75f;
		float InteriorEnvIBLScale = 0.75f;
		float ExteriorSkyIBLScale = 1.5f;
		float InteriorSkyIBLScale = 1.5f;
		float ExteriorEnvIBLSaturation = 1.0f;
