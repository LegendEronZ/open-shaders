	...
	struct RenderContext
	{
		...
		bool BeginVarTable()
		{
			...
			if (ImGui::BeginTable(tableId.c_str(), 2, ImGuiTableFlags_SizingFixedFit)) {
				...
				ImGui::TableSetupColumn(T("feature.effects11.parameter", "Parameter"), ImGuiTableColumnFlags_WidthFixed, w * 0.45f);
				ImGui::TableSetupColumn(T("feature.effects11.value", "Value"), ImGuiTableColumnFlags_WidthFixed, w * 0.55f);
				return true;
			}
			return false;
		}
